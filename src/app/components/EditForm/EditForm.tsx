...
import { z } from "zod";
import { RegistrationAccordion } from "../RegistrationForm/RegistrationAccordion";
import { addressFields, personalFields, purchaseFields, spouseFields } from "../RegistrationForm/utils";
...
export function EditForm() {
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        try {
            fetch(`http://localhost:3001/users/${id}`, options)
        } catch (error) {
            console.log(error)
        }
